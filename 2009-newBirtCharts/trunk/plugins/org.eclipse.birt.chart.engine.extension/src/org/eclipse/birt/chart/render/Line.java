...
public class Line extends AxesRenderer
{
	...
	protected static ILogger logger = Logger.getLogger( "org.eclipse.birt.chart.engine.extension/render" ); //$NON-NLS-1$
			...
			ISeriesRenderingHints isrh ) throws ChartException
	{
		...
		boolean bShowAsTape = cd.getValue( ) == ChartDimension.TWO_DIMENSIONAL_WITH_DEPTH
				|| cd.getValue( ) == ChartDimension.THREE_DIMENSIONAL;

		if ( bShowAsTape ) // 2.5D PLOTS or 3D
		{
